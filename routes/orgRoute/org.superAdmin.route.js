...
routes.get('/all-remoforce/:modifier', roleVerifier(SUPER_ADMIN, ADMIN), getAllRemoforce);
...
routes.get('/all-remo-filters', roleVerifier(SUPER_ADMIN, ADMIN), getAllRemoFilters);
